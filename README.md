# VR Tappy - Selection Success Rate Visualizer
...
![図2 VR Tappyの動作例](https://i.gyazo.com/29a60299b5c25fbae117a2fee5ca1216.png)
*図2: VR Tappyの動作例*
...
1. Unityプロジェクト内の `Editor` フォルダに、本ツールのスクリプトファイルを配置してください。
2. Unityエディタ上でウィンドウを開き、使用を開始できます。
...
* **用途:** VR/ARなど、ユーザーが様々な角度からオブジェクトを見る状況での正確な評価に適しています。
